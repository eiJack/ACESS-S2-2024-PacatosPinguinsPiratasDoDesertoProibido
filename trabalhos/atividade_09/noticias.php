...
<?php include "connectserver.php"; ?>   
    <main>
        ...
        <div class="container-fluid">
            <div class="row paginanoticiasprincipalbordas paginanoticiasprincipalrow">
                <div class="col-12 paginanoticiasprincipalespacoprincipal">
                ...
                <p class="text-center">Acompanhe algumas das principais notícias do mundo NERD!</p>
                    <!-- primeira parte -->
                    <div class="row paginanoticiasprincipalespacoprincipal2 paginanoticiasprincipalrow">
                        <div class="paginanoticiasprincipalbordaroxanoticiadois"></div>
