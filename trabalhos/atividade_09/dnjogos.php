...
<head>
    ...
    <meta name="description" content="Pacatos Pinguins Piratas - O evento Domingo Nerd sendo mais do que apenas um evento, é uma celebração da cultura geek e de tudo o que ela representa, parte dessa celebração são os jogos que tem no dia e que vemos um pouco a seguir.">
...
<div class="container">
        ...
        <section class="col-12 margem4 corroxa">
            <div class="row">
                <div class="col-12 margem2">
                    <h4 class="card-title centropagina">Video game</h4>
                </div>   
                <div class="col-md-5 col-lg-5 d-none d-md-block d-lg-block">
                    <figure class="centropagina margem2">
        ...
        <section class="col-12 margem4 corroxa">
            <div class="row">
                <div class="col-12 margem2">
                    <h4 class="card-title centropagina">Tabuleiro</h4>
                </div>   
                <div class="col-md-5 col-lg-5 d-none d-md-block d-lg-block">
                    <figure class="centropagina margem2">
        ...
        <section class="col-12 margem4 corroxa">
            <div class="row">
                <div class="col-12 margem2">
                    <h4 class="card-title centropagina">Swordplay</h4>
                </div>   
                <div class="col-md-5 col-lg-5 d-none d-md-block d-lg-block">
                    <figure class="centropagina margem2">
